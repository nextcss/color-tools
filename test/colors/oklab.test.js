import { oklab2cmyk, oklab2hex, oklab2hsl, oklab2hwb, oklab2rgb } from '../../src/colors/oklab.js';
...
describe('Convert Oklab color', () => {
  test.concurrent('Oklab neutral to RGB/HEX/HSL/HWB', async () => {
    ...
    expect(oklab2cmyk(o)).toEqual([0, 0, 0, 7]);
  });
  ...
  test.concurrent('Oklab with alpha preserved', async () => {
    ...
    expect(oklab2cmyk(o)).toEqual([0, 0, 0, 7, 93]);
  });
